...
% Setting the information for the wave decomposition
    ...
    Input.Port1.Constant.Method = 'Circular'; 
    Input.Port1.Constant.WaveNumberProp.Model.x =x_upstream;
    Input.Port1.Constant.WaveNumberProp.Model.theta =zeros(size(x_upstream));
    Input.Port1.Constant.WaveNumberProp.Model.r = 25e-3*ones(size(x_upstream));
    ...
    Input.Port2.Constant.WaveNumberProp.Model.theta =zeros(size(x_downstream));
    Input.Port2.Constant.WaveNumberProp.Model.r = 45e-3*ones(size(x_downstream));
