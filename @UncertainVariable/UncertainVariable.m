classdef UncertainVariable < handle
    ...
    methods
        ...
        %Varargin(4) is the degree of freedoms, the number inf is defined.
        %Varargin(5) is the identifier as a cell array of strings for each
        ...
        %            be unique
        %Varargin(6) is the group indentifier, which will be used to group the end uncertainty of the measurement.
        if isempty(varargin)
            return
        end
